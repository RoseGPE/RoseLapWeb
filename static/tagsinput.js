...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      let vitems = self.$element.data("valid");
      if (! vitems.includes(item)) {
        return; // do nothing
      }
  ...
  $.fn.tagsinput = function(arg1, arg2, arg3) {
    ...
    this.each(function() {
      ...
      if (!tagsinput) {
        ...
        console.log("589", tagsinput.options);
        //tagsinput.removeAll();
        //tagsinput.add("lmao", false, tagsinput.options);
        tagsinput.refresh();
        console.log(tagsinput.items());
